    ...
    public partial class ModificarEstudianteForm : Form
    {
        ...
        private Estudiante[] CreateEstudiante()
        {
            Estudiante[] estudiantes = new Estudiante []{
               ...
               , this.txt_carne.Text,  this.txt_promedio.Text,Convert.ToInt32(this.cb_beca.SelectedItem.ToString()),(string)this.cb_sede.SelectedItem,this.txb_direccion.Text)
            };
            return estudiantes;
        }
