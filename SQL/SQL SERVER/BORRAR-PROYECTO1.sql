...
UPDATE ESTUDIANTE.tb_ESTUDIANTE_TELEFONO SET IS_DELETED =1 WHERE ID_ESTUDIANTE=@param_ID_ESTUDIANTE;
UPDATE ESTUDIANTE.tb_ESTUDIANTE_CURSO SET IS_DELETED=1 WHERE ID_ESTUDIANTE=@param_ID_ESTUDIANTE;
