CREATE OR REPLACE FUNCTION ESTUDIANTE.fn_ACTUALIZAR_ESTUDIANTE
(
...
CREATE OR REPLACE FUNCTION ESTUDIANTE.fn_QUITAR_CURSO_ESTUDIANTE
(
...
END;$$
-------------------------------------------------------------
CREATE OR REPLACE FUNCTION ESTUDIANTE.fn_QUITAR_CARRERA_ESTUDIANTE
(
param_NOMBRE_CARRERA VARCHAR(32),
param_CARNE_ESTUDIANTE VARCHAR(32)
) RETURNS INT
...
CREATE OR REPLACE FUNCTION ESTUDIANTE.fn_QUITAR_TELEFONO_ESTUDIANTE
(
param_ID_ESTUDIANTE INT,
...
BEGIN
local_ID_NUMERO ='SELECT ID_TELEFONO FROM ESTUDIANTE.tb_TELEFONO WHERE NUMERO_TELEFONO=@param_NUMERO';
