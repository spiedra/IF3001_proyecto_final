...
IF EXISTS (SELECT ID_ESTUDIANTE, ID_BECA FROM ESTUDIANTE.tb_ESTUDIANTE_BECA WHERE ID_ESTUDIANTE=param_ID_ESTUDIANTE AND ID_BECA=local_id_beca AND IS_DELETED=1) THEN
	 ...
	 ELSEIF NOT EXISTS (SELECT ID_ESTUDIANTE, ID_BECA FROM ESTUDIANTE.tb_ESTUDIANTE_BECA WHERE ID_ESTUDIANTE=param_ID_ESTUDIANTE AND ID_BECA=local_id_beca AND IS_DELETED=0) THEN
...
ELSEIF NOT EXISTS (SELECT ID_ESTUDIANTE, ID_SEDE FROM ESTUDIANTE.tb_ESTUDIANTE_SEDE WHERE ID_ESTUDIANTE=param_ID_ESTUDIANTE AND ID_SEDE=local_ID_SEDE AND IS_DELETED=0) THEN
