DELIMITER $$
CREATE PROCEDURE ESTUDIANTE.sp_INSERTAR_ESTUDIANTE
(
...
DECLARE local_id_sede INT;
 ...
 ELSE
		...
		SET local_id_direccion=(SELECT LAST_INSERT_ID());
		...
		SET local_id_estudiante=(SELECT LAST_INSERT_ID());
...
BEGIN
	...
	INSERT INTO ESTUDIANTE.tb_ESTUDIANTE_SEDE (ID_ESTUDIANTE,ID_SEDE) VALUES
	(
	param_ID_ESTUDIANTE,
	local_ID_SEDE
	);
...
--------------------------------------------------------
DELIMITER $$
CREATE PROCEDURE ESTUDIANTE.sp_INSERTAR_TELEFONO_ESTUDIANTE
(
IN param_NUMERO_TELEFONO VARCHAR(32),
IN param_ID_ESTUDIANTE INT,
OUT msg INT
)
...
BEGIN
 ...
 IF EXISTS (SELECT ID_ESTUDIANTE, ID_TELEFONO FROM ESTUDIANTE.tb_ESTUDIANTE_TELEFONO WHERE ID_TELEFONO=local_id_telefono_verificar AND ID_ESTUDIANTE=param_ID_ESTUDIANTE) THEN
	...
	ELSE
			...
			SET local_ID_TELEFONO=(SELECT LAST_INSERT_ID());
...
---------------------------------------------------
DELIMITER $$
CREATE PROCEDURE ESTUDIANTE.sp_INSERTAR_CURSO_ESTUDIANTE
(
IN param_ID_ESTUDIANTE INT,
...
-------------------------------------------------
DELIMITER $$
CREATE PROCEDURE ESTUDIANTE.sp_INSERTAR_CARRERA_ESTUDIANTE
(
